...
Videogame.belongsToMany(Genre,{through:'videogame_genres',timestamps:false});//many to many relationship
Genre.belongsToMany(Videogame,{through:'videogame_genres',timestamps:false});//many to many relationship
module.exports = {
